    ...
    return (
        <TouchableOpacity className="flex flex-col items-start w-60 h-80 relative" onPress={onPress}>
            ...
            <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
                ...
                <Text className="text-base font-rubik text-white">22 W 15th Street, NY</Text>
...
export const Card = ({ onPress }: props) => {
    return (
        <TouchableOpacity
            ...
            onPress={onPress}
        >
            <View className="flex flex-row items-center bg-white/90 p-1 rounded-full absolute top-5 right-5">
            ...
            <View className="flex flex-col mt-2">
                ...
                <Text className="text-xs font-rubik text-black-200">22 W 15th Street, NY</Text>
