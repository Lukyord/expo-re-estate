...
import { agentImages, galleryImages, propertiesImages, reviewImages } from "@/constants/db-data";
...
async function seed() {
    try {
        ...
        for (let i = 1; i <= 20; i++) {
            ...
            const assignedGalleries = getRandomSubset(galleries, 3, 8); // 3 çto 8 galleries
